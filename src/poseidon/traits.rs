...
pub trait PoseidonDefaultParameters<const N: usize>: FpConfig<N> {
...
pub fn get_default_poseidon_parameters_internal<
    F: PrimeField,
    P: PoseidonDefaultParameters<N>,
    const N: usize,
>(
    rate: usize,
    optimized_for_weights: bool,
...
macro_rules! impl_poseidon_default_parameters_field {
    ($field: ident, $params: expr) => {
        impl<P: PoseidonDefaultParameters<$params>> PoseidonDefaultParametersField for $field<P> {
            fn get_default_poseidon_parameters(
                rate: usize,
                optimized_for_weights: bool,
            ) -> Option<PoseidonParameters<Self>> {
                get_default_poseidon_parameters_internal::<Self, P, $params>(
                    rate,
...
impl_poseidon_default_parameters_field!(Fp64, 1);
impl_poseidon_default_parameters_field!(Fp256, 4);
impl_poseidon_default_parameters_field!(Fp320, 5);
impl_poseidon_default_parameters_field!(Fp384, 6);
impl_poseidon_default_parameters_field!(Fp448, 7);
impl_poseidon_default_parameters_field!(Fp768, 12);
impl_poseidon_default_parameters_field!(Fp832, 13);
...
mod test {
    ...
    use ark_ff::{BigInteger256, FpConfig, MontBackend, MontConfig};
